...
5. Current version: **1.0.0** (submission-ready local pipeline: cleaning, blocking + recall audit, parallel features, LightGBM matcher, validated outputs; held-out full-candidate macro F0.5 0.8488). Earlier: 0.2.0 = Kaggle-only compute rules and the cascade C+B design; 0.1.0 = initial docs, EDA and benchmark tooling, knowledge graph.
